...
exports.playlistRepository = exports.albumRepository = exports.songRepository = void 0;
const song_1 = require("../common/song");
const songrepository_1 = require("../server/songrepository");
const album_1 = require("../common/album");
const albumrepository_1 = require("../server/albumrepository");
const playlist_1 = require("../common/playlist");
const playlistrepository_1 = require("../server/playlistrepository");
const songRepository = new songrepository_1.SongRepository();
exports.songRepository = songRepository;
// First Album
const song1 = new song_1.Song();
song1.id = 1;
...
// Creating albums
const albumRepository = new albumrepository_1.AlbumRepository();
...
//# sourceMappingURL=song-album-creator.js.map